const names= ['Ricardo','Joelma','Carlos','Manoel']
for(let i= 0;i<names.length;i++){
  htmlTemplate=`<p>${names[i]}</p>`
  //console.log(htmlTemplate)
}

const names = ["Jason","Michael","Alice"]
...
for (let i = 0 ; i< arrays.length;i++){
  let int1 = parseInt(arrays[0][i])
  let int2 = parseInt(arrays[1][i])
  soma1+=int1
  soma2+=int2
  //console.log(int1)
  //console.log(int2) 
