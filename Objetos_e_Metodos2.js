/*let user = {
  ...
  logout: function(){
    console.log(`Você deslogou de ${user.name}`)
  }
}
user.login();
user.logout();
...
/*
  ...
  - Exiba o array de amigos no console para verificar se o novo amigo(a) foi  
    adicionado.
*/
const addAmigoDoGato = array => array.push("Milton");
  

//addAmigoDoGato(cat.bestFriends)
...
/*
  ...
  - Exiba a nova cor do gato no console, também utilizando a sintaxe de  
    colchetes.
*/
/*const addCorNoGato = (objeto,color) => {
  const corNova = "Preto"
  objeto+=color;   

}
const corNova = "Preto"
addCorNoGato(cat.color,corNova)
...
*/
const verifyIsObject = isObject=> typeof isObject === "object"
 
console.log(verifyIsObject(cat))
/*
  07
...
const sumPets = (catName,dogName)=>{
  const sumAgePet = catName + dogName
  return `A soma das idades de ${catName} e ${dogName} é ${sumAgePet}.`
}
console.log(sumPets(cat.nam,dog.name)) // falta fazer
/*
  08
