...
//console.log(convertToString(14))
...
//Resolução do curso muito melhor kk
...
*/
const allToLowerCase = (valor)=>{
  return valor.toLowerCase()
}
const lower = allToLowerCase("BOM DIA")
//console.log(lower)
//Resolução do curso  bem melhor
...
*/
/*let bol = false
const verifyArguments = (item,array) =>{
...
const arrayVerify= ["Macaco","Onça","Leão","cutia"]
*/
//console.log(verifyArguments("Onça", arrayVerify))

const arrayVerify= ["Macaco","Onça","Leão","cutia"]
let verify = false
const verifyArguments = (arrayVerify,arrayitems) =>{
  arrayVerify.forEach((item)=>{
...
//console.log(verifyArguments(arrayVerify,"elefante"))

//Resolução do curso bem melhor kk mesmo resultado em apenas 1 linha
...
*/
/*const concatFunc = (array1,array2) =>{
  return array1.concat(array2)
}
const firstArray = ["O","Dia","é","Bonito"]
const secondArray = ["A","Noite","é","Bonita"]
const result = concatFunc(firstArray,secondArray)
console.log(result)
*/
...
const arrayLastItem = ["A","Dona","Aranha","Subiu","Pela","Parede"]
const resultado = removeLastItem(arrayLastItem)*/
...
//console.log(removeLastItem([1,2,4,5]))
/*
  08
...
*/
/*
const verifyNull =(valor)=>{
  return valor === null
}
const functionResult = verifyNull(null)
...
*/
const funcaoCallback = (value,callback)=>{
  return callback(value)
}
const tripleNumber = (number) =>{
  return number*3;
}
//console.log(funcaoCallback(10,tripleNumber)) // falta fazer*/
...
*/
//Resolução do curso mesma coisa
let paragraphs = ''
...
const curtidas = (array)=>{ // nao consegui fazer 
  for(let i= 0;i<array.length;i++){
    if (array.length===1){
      return `${array[i]} curtiu isso`
    }
    else if(array.length ===2){
      return `${array[i]} e ${array[i+1]} curtiu isso`
    }
    else if(array.length ===3){
      return `${array[i]} , ${array[i+1]} e ${array[i+2]} curtiu isso`
    }
    else if(array.length >=4){
      return `${array[i]} e ${array[i+1]} e mais ${array.length} pessoas curtiram isso`
    }
...
const getLikeMessage = (names = [])=>{
  ...
  switch(names.length){
    ...
    default:
      return  `${[firstName]} e ${secondName} e mais ${totalNamesMinusTwo} pessoas curtiram isso`
  }
}
console.log(getLikeMessage(["Rick","Bryan","Lima","Batista"]))
